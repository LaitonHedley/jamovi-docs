...
In those cases, use [Transformed Variables](/data_3_transformed_variables) instead. They allow you to define a single rule and apply it across as many columns as you like. They are also the best choice for \"if-then\" recoding.
