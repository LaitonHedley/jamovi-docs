...
<video autoplay loop muted playsinline poster="/images/um_analysis.png" title="Performing an Analysis" style="width: 80%; display: block; margin: 1rem 0"><source src="/images/um_analysis.webm" type="video/webm" /><source src="/images/um_analysis.mp4" type="video/mp4" /></video>
...
<video autoplay loop muted playsinline poster="/images/um_copyPaste.png" title="Copy-and-Paste" style="width: 80%; display: block; margin: 1rem 0"><source src="/images/um_copyPaste.webm" type="video/webm" /><source src="/images/um_copyPaste.mp4" type="video/mp4" /></video>
