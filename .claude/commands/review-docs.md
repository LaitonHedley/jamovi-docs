Perform a structured user-perspective review of this documentation page: $ARGUMENTS

If no file is specified, ask the user which file to review.

Read the file in full, then return feedback grouped under these headings:
...
End with a one-line verdict: **Ready to publish**, **Needs minor work**, or **Needs significant work**.

Keep each issue concise: section heading + one sentence. Do not quote large blocks of text back.
